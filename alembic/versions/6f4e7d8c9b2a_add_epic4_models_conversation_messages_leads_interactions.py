...
def upgrade() -> None:
    ...
    messagedirection = postgresql.ENUM('INBOUND', 'OUTBOUND', name='messagedirection', create_type=False)
    messagedirection.create(op.get_bind(), checkfirst=True)
    
    # Criar enum InteractionType (se não existir)
    interactiontype = postgresql.ENUM('PHONE_CALL', 'WHATSAPP_MESSAGE', 'EMAIL', 'IN_PERSON', 'OTHER', 
    ...
    op.create_table('conversation_messages',
                    ...
                    sa.Column('direction', postgresql.ENUM('INBOUND', 'OUTBOUND', name='messagedirection', create_type=False), 
                              nullable=False,
    ...
    op.create_table('lead_interactions',
                    ...
                    sa.Column('interaction_type', postgresql.ENUM('PHONE_CALL', 'WHATSAPP_MESSAGE', 'EMAIL', 'IN_PERSON', 'OTHER',
                              name='interactiontype', create_type=False), nullable=False,
